...
from funcs import augment_days, blue_palette, grey_palette, orange_palette, font_family, get_palette

palette = get_palette()


def get_active_and_new_customers(month_int, max_year, df, range=3, palette=palette, country=None, customer=None):
    # range = 3
    # month_int = 7
    # max_year = 2010
    # df = df
    ...
    customers_gp['colors'] = customers_gp['colors'].map(lambda x: palette[x])
    # customers_gp
