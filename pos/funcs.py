...
def augment_days(month_int, year, df):
    ...
    df_augmented = df.set_index('Date').reindex(updated_dates).fillna(0.0).rename_axis('Date').reset_index()
...
def get_palette():
    ...
    if palette == "red_palette":
        ...
        sys.exit('You did not choose the correct palette')
...
#
#     for column in ['Total Sales', 'Sales per Store', 'Average Inventory Amount', 'Total On-Hand Amount',
...
#             'suffix': ''
#         }
#     for column in ['Days Sales of Inventory']:
#         dict_number_format[column] = {
#             'prefix': '',
#             'value_format': number_format["value_float"],
#             'suffix': ' d'
#         }
#     for column in ['Inventory Turns']:
#         dict_number_format[column] = {
#             'prefix': '',
#             'value_format': number_format["value_float"],
#             'suffix': ''
#         }
#     for column in ['Nb of Stores', 'Nb of New Stores', 'Nb of Products']:
#         dict_number_format[column] = {
#             'prefix': '',
#             'value_format': number_format["value_int"],
#             'suffix': ''
